  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        toolbox: "Cables",
        find: ["Cables → group"],
        do: "Left list → Cables. Grab group. Snap it under the hat. Click the name and type detect.",
      ...
      },
      {
        title: "Send the name",
        toolbox: "Cables",
        find: ["Cables → send … along …", "Sensing → detected name"],
        do: "Still in Cables, grab send … along … and drop it inside the detect group. Name the cable who. Then left list → Sensing, grab detected name, leave the index at 0, plug that into the send's value socket.",
      ...
      },
      {
        ...
        toolbox: "Cables",
        find: ["Cables → group"],
        do: "Cables → group again. Drop it under the first group (still in the hat). Name it greet.",
      ...
      },
      {
        ...
        toolbox: "Chat",
        find: ["Chat → say … on channel …", "Cables → along …"],
        do: "Left list → Chat, grab say … on channel … and drop it inside greet. Then Cables → along … (the small value brick, not send). Name it who. Plug along who into the say message socket. Delete the default string if it fights you. The noodle should appear.",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        toolbox: "Cables",
        find: ["Cables → group", "Cables → send … along …", "Sensing → detected name"],
        do: "Inside when sensor detects: Cables → group, name it sense. Inside that, Cables → send … along …, cable name who. Value socket: Sensing → detected name, index 0.",
      ...
      },
      {
        ...
        toolbox: "Cables",
        find: ["Cables → group", "Chat → say … on channel …", "Cables → along …"],
        do: "Second Cables → group named greet, still under the sensor hat. Inside it: Chat → say … on channel …, message socket = Cables → along … named who.",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        toolbox: "Cables",
        find: ["Cables → group", "Cables → send … along …", "Sensing → detected name"],
        do: "Cables → group, name it detect, snap under the hat. Inside: Cables → send … along …, cable who, value = Sensing → detected name, index 0.",
      ...
      },
      {
        ...
        toolbox: "Cables",
        find: ["Cables → send … along …", "Sensing → detected key"],
        do: "Still inside detect, under the first send: another Cables → send … along …. Name this one id. Value is Sensing → detected key, index 0.",
